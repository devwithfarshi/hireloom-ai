...
export function RegisterPage() {
  ...
  const handleRoleSelect = (selectedRole: 'RECRUITER' | 'CANDIDATE') => {
      ...
      {!role ? (
        <div className="space-y-6">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <Card className="p-6 cursor-pointer hover:border-primary transition-colors" onClick={() => handleRoleSelect('RECRUITER')}>
            ...
            <Card className="p-6 cursor-pointer hover:border-primary transition-colors" onClick={() => handleRoleSelect('CANDIDATE')}>
              <div className="text-center space-y-4">
